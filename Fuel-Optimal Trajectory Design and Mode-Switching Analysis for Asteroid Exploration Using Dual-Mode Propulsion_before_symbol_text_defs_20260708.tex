...
The remainder of this paper is organized as follows. Section \hyperref[sec:methodology]{II} presents the dynamical model in modified equinoctial elements, the indirect formulation of the fuel optimal problem for single thruster dual mode propulsion, the two point boundary value problem, and the definitions of the four propulsion schemes and the two dimensional critical boundary. Section \hyperref[sec:simulation]{III} reports the Earth to Ceres numerical simulations, including representative trajectories with mode switching, fuel performance comparisons among the four schemes, and the boundary analysis in the thrust ratio and specific impulse ratio plane. Finally, Section \hyperref[sec:conclusions]{IV} summarizes the main findings and discusses their implications for propulsion parameter matching in asteroid exploration missions.
